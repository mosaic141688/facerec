        ...
        <v-content>
            <v-container fluid>
                <v-slide-y-transition mode="out-in">
                    <router-view @component_event="handle_events"></router-view>
...
<script>
   // import ThingTable from "./thing-table";
    ...
    export default {
        ...
        data(){
            return {
                ...
                items: [
                    ...
                    {icon: 'people', title: 'Attendance',route:'attendance'},
                    {icon: 'schedule', title: 'Exam Schedule',route:'exam-schedule'},
                    {icon:'folder_open', title:'Attendance Report',route:'attendance-report'},
                    {icon:'person_add', title:'Register Student',route:'register-student'}
        ...
        methods: {
            handle_events(event){
                console.log('Handles event',event,this.$route.path)
            },
            logout() {
                this.sign_out()
                    .then(x => {
